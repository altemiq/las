// -----------------------------------------------------------------------
// <copyright file="GeoProjectionConverter.cs" company="Altemiq">
...
/// <summary>
/// The geo-projection converter.
/// </summary>
public static class GeoProjectionConverter
{
    /// <summary>
    /// Tries to get the GeoTiff info.
    /// </summary>
    ...
    public static bool TryGetGeoTiffInfo(GeoKeyEntry geoKeyEntry, GeoDoubleParamsTag? geoDoubleParams, GeoAsciiParamsTag? geoAsciiParams, out string key, out string value)
    {
        if (Enum.IsDefined(geoKeyEntry.KeyId))
        {
            key = geoKeyEntry.KeyId.ToString();

            if (geoDoubleParams?.TryGetValue(geoKeyEntry, out var doubleValue) is true)
            {
                value = doubleValue.ToString("N10", System.Globalization.CultureInfo.InvariantCulture);
                return true;
            }

            if (geoAsciiParams?.TryGetValue(geoKeyEntry, out var asciiValue) is true)
            {
                value = asciiValue;
                return true;
            }

            value = geoKeyEntry switch
            {
                ...
                { KeyId: GeoKey.GeodeticCRSGeoKey or GeoKey.GeodeticDatumGeoKey or GeoKey.PrimeMeridianGeoKey or GeoKey.EllipsoidGeoKey or GeoKey.ProjectedCRSGeoKey or GeoKey.ProjectionGeoKey, ValueOffset: 32767 } => "user-defined",
                ...
                { KeyId: GeoKey.GeogToWgs84GeoKey } => GetToWgs84(geoKeyEntry, geoDoubleParams),
                { KeyId: GeoKey.ProjectedCRSGeoKey, ValueOffset: >= 32601 and <= 32660 and var v } => FormatPcs("WGS 84", v - 32600),
                ...
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: >= 16001 and <= 16060 } => string.Create(System.Globalization.CultureInfo.InvariantCulture, $"Proj_UTM_zone_{geoKeyEntry.ValueOffset - 16000}N"),
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: >= 16101 and <= 16160 } => string.Create(System.Globalization.CultureInfo.InvariantCulture, $"Proj_UTM_zone_{geoKeyEntry.ValueOffset - 16000}S"),
                ...
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10431 } => "Proj_California_CS83_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10432 } => "Proj_California_CS83_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10433 } => "Proj_California_CS83_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10434 } => "Proj_California_CS83_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10435 } => "Proj_California_CS83_5",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 10436 } => "Proj_California_CS83_6",
                ...
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15001 } => "Proj_Alaska_CS27_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15002 } => "Proj_Alaska_CS27_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15003 } => "Proj_Alaska_CS27_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15004 } => "Proj_Alaska_CS27_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15005 } => "Proj_Alaska_CS27_5",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15006 } => "Proj_Alaska_CS27_6",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15007 } => "Proj_Alaska_CS27_7",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15008 } => "Proj_Alaska_CS27_8",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15009 } => "Proj_Alaska_CS27_9",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15010 } => "Proj_Alaska_CS27_10",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15031 } => "Proj_Alaska_CS83_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15032 } => "Proj_Alaska_CS83_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15033 } => "Proj_Alaska_CS83_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15034 } => "Proj_Alaska_CS83_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15035 } => "Proj_Alaska_CS83_5",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15036 } => "Proj_Alaska_CS83_6",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15037 } => "Proj_Alaska_CS83_7",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15038 } => "Proj_Alaska_CS83_8",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15039 } => "Proj_Alaska_CS83_9",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15040 } => "Proj_Alaska_CS83_10",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15101 } => "Proj_Hawaii_CS27_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15102 } => "Proj_Hawaii_CS27_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15103 } => "Proj_Hawaii_CS27_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15104 } => "Proj_Hawaii_CS27_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15105 } => "Proj_Hawaii_CS27_5",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15131 } => "Proj_Hawaii_CS83_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15132 } => "Proj_Hawaii_CS83_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15133 } => "Proj_Hawaii_CS83_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15134 } => "Proj_Hawaii_CS83_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 15135 } => "Proj_Hawaii_CS83_5",
                ...
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17348 } => "Proj_Map_Grid_of_Australia_48",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17349 } => "Proj_Map_Grid_of_Australia_49",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17350 } => "Proj_Map_Grid_of_Australia_50",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17351 } => "Proj_Map_Grid_of_Australia_51",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17352 } => "Proj_Map_Grid_of_Australia_52",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17353 } => "Proj_Map_Grid_of_Australia_53",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17354 } => "Proj_Map_Grid_of_Australia_54",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17355 } => "Proj_Map_Grid_of_Australia_55",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17356 } => "Proj_Map_Grid_of_Australia_56",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17357 } => "Proj_Map_Grid_of_Australia_57",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17358 } => "Proj_Map_Grid_of_Australia_58",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17448 } => "Proj_Australian_Map_Grid_48",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17449 } => "Proj_Australian_Map_Grid_49",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17450 } => "Proj_Australian_Map_Grid_50",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17451 } => "Proj_Australian_Map_Grid_51",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17452 } => "Proj_Australian_Map_Grid_52",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17453 } => "Proj_Australian_Map_Grid_53",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17454 } => "Proj_Australian_Map_Grid_54",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17455 } => "Proj_Australian_Map_Grid_55",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17456 } => "Proj_Australian_Map_Grid_56",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17457 } => "Proj_Australian_Map_Grid_57",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 17458 } => "Proj_Australian_Map_Grid_58",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18031 } => "Proj_Argentina_1",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18032 } => "Proj_Argentina_2",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18033 } => "Proj_Argentina_3",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18034 } => "Proj_Argentina_4",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18035 } => "Proj_Argentina_5",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18036 } => "Proj_Argentina_6",
                { KeyId: GeoKey.ProjectionGeoKey, ValueOffset: 18037 } => "Proj_Argentina_7",
                ...
                { KeyId: GeoKey.VerticalGeoKey, ValueOffset: 5783 } => "Deutsches Haupthoehennetz 1992",
                ...
                { KeyId: GeoKey.VerticalGeoKey, ValueOffset: 7837 } => "Deutsches Haupthoehennetz 2016",
                { KeyId: GeoKey.VerticalDatumGeoKey } => $"Vertical Datum Codes {geoKeyEntry.ValueOffset}",
                { ValueOffset: var kk } => $"look-up for {kk} not implemented",
            };

            return true;

            static string GetToWgs84(GeoKeyEntry geokeye, GeoDoubleParamsTag? geoKeyDouble)
            {
                var builder = new System.Text.StringBuilder("TOWGS84[");
                for (var i = 0; i < geokeye.Count; i++)
                {
                    if (i is not 0)
                    {
                        builder.Append(',');
        ...
        key = string.Empty;
        value = $"GeoKey[{geoKeyEntry.KeyId}] unknown.";
        return false;
    }
}