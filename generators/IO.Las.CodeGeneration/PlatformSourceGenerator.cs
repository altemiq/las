...
public class PlatformSourceGenerator : BaseSourceGenerator
{
    ...
    public override void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        static (IReadOnlyCollection<string?> Ids, IReadOnlyCollection<string?> Types) GetIdsAndTypes(AdditionalText input)
        {
        ...
        static IReadOnlyCollection<(string? Id, string? Type, char Code)> GetPlatforms(AdditionalText input)
        {
    ...
    private static CompilationUnitSyntax CreatePlatforms(BaseNamespaceDeclarationSyntax @namespace, IEnumerable<(string? Id, string? Type, char Code)> platforms)
    {
        ...
        static IEnumerable<MemberDeclarationSyntax> GetFields(IEnumerable<(string? Id, string? Type, char Code)> platforms)
        {
            ...
            {
                var idName = CleanupIdentifier(id);
                var typeName = CleanupIdentifier(type);
                ...
                static SwitchExpressionArmSyntax GetSwitchExpressionArm(string id, char code)
                {
                    return SwitchExpressionArm(
                        ...
                        MemberAccessExpression(
                            ...
                            IdentifierName(CleanupIdentifier(id))));
                }
            }
        }
