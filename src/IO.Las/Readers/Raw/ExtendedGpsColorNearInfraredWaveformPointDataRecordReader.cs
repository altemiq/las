...
/// </summary>
public sealed class ExtendedGpsColorNearInfraredWaveformPointDataRecordReader : PointDataRecordReader<ExtendedGpsColorNearInfraredWaveformPointDataRecord>
{
    /// <inheritdoc />
