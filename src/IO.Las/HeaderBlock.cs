...
#if LAS1_5_OR_GREATER
    /// <include file="Properties/v1.5/Documentation.xml" path="doc/members/member[@name='M:Altavec.IO.Las.HeaderBlock.Constructor']/*" />
#elif LAS1_4_OR_GREATER
    /// <include file="Properties/v1.4/Documentation.xml" path="doc/members/member[@name='M:Altavec.IO.Las.HeaderBlock.Constructor']/*" />
#elif LAS1_2_OR_GREATER
    /// <include file="Properties/v1.2/Documentation.xml" path="doc/members/member[@name='M:Altavec.IO.Las.HeaderBlock.Constructor']/*" />
#else
    /// <include file="Properties/v1.1/Documentation.xml" path="doc/members/member[@name='M:Altavec.IO.Las.HeaderBlock.Constructor']/*" />
#endif
...
#if LAS1_5_OR_GREATER
    /// <include file="Properties/v1.5/Documentation.xml" path="doc/members/member[@name='P:Altavec.IO.Las.HeaderBlock.GlobalEncoding']/*" />
    public GlobalEncoding GlobalEncoding { get; }
#elif LAS1_4_OR_GREATER
    /// <include file="Properties/v1.4/Documentation.xml" path="doc/members/member[@name='P:Altavec.IO.Las.HeaderBlock.GlobalEncoding']/*" />
    public GlobalEncoding GlobalEncoding { get; }
#elif LAS1_3_OR_GREATER
    /// <include file="Properties/v1.3/Documentation.xml" path="doc/members/member[@name='P:Altavec.IO.Las.HeaderBlock.GlobalEncoding']/*" />
    public GlobalEncoding GlobalEncoding { get; }
#elif LAS1_2_OR_GREATER
    /// <include file="Properties/v1.2/Documentation.xml" path="doc/members/member[@name='P:Altavec.IO.Las.HeaderBlock.GlobalEncoding']/*" />
    public GlobalEncoding GlobalEncoding { get; }
#endif
