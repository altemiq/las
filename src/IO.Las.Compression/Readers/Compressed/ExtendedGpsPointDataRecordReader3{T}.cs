// -----------------------------------------------------------------------
// <copyright file="ExtendedGpsPointDataRecordReader3{T}.cs" company="Altemiq">
...
internal abstract class ExtendedGpsPointDataRecordReader3<T> : ICompressedPointDataRecordReader, IContext
    where T : IExtendedPointDataRecord
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtendedGpsPointDataRecordReader3{T}"/> class.
    /// </summary>
    ...
    protected ExtendedGpsPointDataRecordReader3(ArithmeticDecoder decoder, int pointDataLength, int basePointDataLength, DecompressSelections decompressSelective = DecompressSelections.All)
    {
    ...
    private void ReadGpsTime()
    {
        while (true)
        {
            ...
            else
            {
                ...
                {
                    case 1:
                        processingContext.LastGpsTime[processingContext.Last] = BitConverter.Int64BitsToUInt64Bits(
                            BitConverter.UInt64BitsToInt64Bits(processingContext.LastGpsTime[processingContext.Last]) + processingContext.GpsTimeIntegerDecompressor.Decompress(processingContext.LastGpsTimeDiff[processingContext.Last], 1));
                        processingContext.MultiExtremeCounter[processingContext.Last] = default;
                        break;
