// -----------------------------------------------------------------------
// <copyright file="ExtendedGpsPointDataRecordReader4{T}.cs" company="Altemiq">
    ...
    where T : IExtendedPointDataRecord
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtendedGpsPointDataRecordReader4{T}"/> class.
    /// </summary>
