// -----------------------------------------------------------------------
// <copyright file="ExtendedGpsPointDataRecordWriter3.cs" company="Altemiq">
...
internal sealed class ExtendedGpsPointDataRecordWriter3(ArithmeticEncoder encoder, int extraBytes) : ExtendedGpsPointDataRecordWriter3<ExtendedGpsPointDataRecord>(encoder)
{
    ...
    public override bool Initialize(ReadOnlySpan<byte> item, ref uint context) => base.Initialize(item, ref context)
        && this.byteWriter.Initialize(item[ExtendedGpsPointDataRecord.Size..], ref context);
    ...
    public override void Write(Span<byte> item, ref uint context)
    {
        ...
        this.byteWriter.Write(item[ExtendedGpsPointDataRecord.Size..], ref context);
    }
    ...
    public override async ValueTask<uint> WriteAsync(Memory<byte> item, uint context, CancellationToken cancellationToken = default)
    {
        ...
        return await this.byteWriter.WriteAsync(item[ExtendedGpsPointDataRecord.Size..], context, cancellationToken).ConfigureAwait(false);
    }
}