...
internal sealed class GpsColorWaveformPointDataRecordWriter(ArithmeticEncoder encoder, int extraBytes) : PointDataRecordWriter<GpsColorWaveformPointDataRecord>(encoder)
{
