// -----------------------------------------------------------------------
// <copyright file="ExtendedGpsColorPointDataRecordWriter4.cs" company="Altemiq">
...
internal sealed class ExtendedGpsColorPointDataRecordWriter4(ArithmeticEncoder encoder, int extraBytes) : ExtendedGpsPointDataRecordWriter4<ExtendedGpsColorPointDataRecord>(encoder)
{
    private readonly ColorWriter4 colorWriter = new(encoder);
