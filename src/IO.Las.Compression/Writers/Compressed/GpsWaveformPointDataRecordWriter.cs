...
internal sealed class GpsWaveformPointDataRecordWriter(ArithmeticEncoder encoder, int extraBytes) : PointDataRecordWriter<GpsWaveformPointDataRecord>(encoder)
{
