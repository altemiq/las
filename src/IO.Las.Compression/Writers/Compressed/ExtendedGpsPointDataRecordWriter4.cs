...
internal sealed class ExtendedGpsPointDataRecordWriter4(ArithmeticEncoder encoder, int extraBytes) : ExtendedGpsPointDataRecordWriter4<ExtendedGpsPointDataRecord>(encoder)
{
