...
public class S3LasTests
{
    ...
    {
        yield return static () => (Data.S3UriData.S3Scheme, null);
        yield return static () => (Data.S3UriData.PathStyle, Amazon.RegionEndpoint.APSoutheast2);
        yield return static () => (Data.S3UriData.PathStyleNoRegion, Amazon.RegionEndpoint.USEast1);
        yield return static () => (Data.S3UriData.PathStyleDash, Amazon.RegionEndpoint.APSoutheast2);
        yield return static () => (Data.S3UriData.VirtualHostedStyle, Amazon.RegionEndpoint.APSoutheast2);
    }
}